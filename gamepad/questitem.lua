...
local ITEM_TARGET = {
    ...
    [128651] = "none",    -- Critter Hand Cannon (39656: Wolf Pack Attack)
    ...
    [129725] = "none",    -- Smoldering Torch (40120: A Murky Fate)
    [130074] = "none",    -- Flare Gun (40228: Scout It Out)
    ...
    [134119] = "target",  -- Overloaded Collar (41216: Survival of the Fittest)
    ...
    [138253] = "none",    -- Leyworm Bait (42406: To Tame the Beast)
    [138815] = "none",    -- Old Grizzleback's Staff (42884: Grassroots Effort)
    ...
    [142401] = "none",    -- Telemancy Orbs (44815: Sick of the Sycophants)
    ...
    [143661] = "none",    -- Soul Prism of the Illidari (45176: Trial of Valor: The Once and Future Lord of Shadows)
    ...
    [152648] = "none",    -- Brightsoul Scepter (48637: Cleansing Fire)
    [152657] = "target",  -- Target Designator (48640: The Immortal Squadron)
    [152971] = "target",  -- Talisman of the Prophet (48691: Soul Chain)
    [152992] = "target",  -- Sacred Stone (47563: Spirits of the Fallen)
    [153249] = "target",  -- Y'mera's Attuning Crystal (48105: Peer Review)
    ...
    [229420] = "none",    -- Anima Orb (86195: Slateback Soccer / 86361: Are You Kitting Me? / 86603: Ray-ket Ball)
    ...
    [232992] = "none",    -- Large Bug Bits (86187: The Smallest Possible Effort)
    [233028] = "none",    -- Flamethrower (86201: Watch me Make These Bugs Expire)
    [233195] = "none",    -- Pheromone Dispenser (86194: The Scent of Love)
    [233222] = "skip",    -- Nullbomb (84865: Divide and Conquer)  -- Provided as a duty action.
    [233486] = "none",    -- Pheromone Disperser (86350: Eau de Foxy)
    [233552] = "target",  -- Tranquilizing Dart (86362: What Does the Fox Dream?)
    [234457] = "target",  -- Butcher's Knife (86355: Using the Whole Animal)
    [235384] = "none",    -- Anima Vacuum (86595: Custodial Duties / 86606: The Golden Ooze)
    [235411] = "none",    -- Tagging Dart (86601: Triple Twenty)  -- Conceptually "target", but forces point-and-click mode even if a valid target is selected.
    [235500] = "target",  -- Tranquilizing Dart (86604: Dubious Intent)
    [235851] = "target",  -- Lasso (86605: Booster Shots)
    [235898] = "none",    -- Containment Trap (87285: Marking Matrix)
    [236406] = "none",    -- Appropriated S.E.L.F.I.E. Camera (87294: A Truth Universally Acknowledged)
    [236641] = "none",    -- Watering Jug (87339: Ongoing Activities)
    [236679] = "none",    -- Essence Scanner (87358: Umbral Facade)
    [237009] = "none",    -- Zo'kita Safety Gear (87420: Basket of Zo'kita Fruit)
    [237012] = "none",    -- Appropriated Azerothian Camera (87412: K'arrocing Photos)
