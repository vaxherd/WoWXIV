...
local ITEM_TARGET = {
    ...
    [120960] = "skip",    -- Tidestone Vault Key (37469: The Tidestone: Shattered)  -- Using it doesn't do anything (despite the in-game description "Use: Open the Tidestone Vault Door"); having it in your inventory lets you open the door by interacting with it.
